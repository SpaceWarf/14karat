...
import seiryuu from '../../assets/images/spirits/seiryuu.jpg';
  ...
  return (
    <div className="GuardiansListing">
      <div className='Guardian'>
        <Header id="seiryuu" element={<p>Seiryū (<span className='Kanji'>青竜</span>)</p>} decorated />
        <div className='Description'>
          <img src={seiryuu} alt='Seiryū' />
          <p>
            <a href='https://yokai.com/seiryuu/' target='_blank' rel="noreferrer">Seiryū (青竜)</a>, the Azure Dragon, is depicted as a large blue-green dragon with a
            long tongue. He is one of the Four Symbols (Seiryū, Suzaku, Genbu, and Byakko), each associated with a cardinal direction. Seiryū guards over the East,
            has control over the rain, and stands as a symbol of benevolance and creativity
          </p>
        </div>
      </div>
      <div className='Guardian'>
      ...
      <div className='Guardian'>
        ...
        <div className='Description'>
          <p>
            ...
            fur and a commanding presence. He is one of the Four Symbols (Seiryū, Suzaku, Genbu, and Byakko), each associated with a cardinal direction. Its white color symbolizes purity,
