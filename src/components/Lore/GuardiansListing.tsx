...
import genbu from '../../assets/images/spirits/genbu.jpg';
...
function GuardiansListing() {
  ...
  return (
    <div className="GuardiansListing">
      ...
      <div className='Guardian'>
        <Header id="genbu" element={<p>Genbu (<span className='Kanji'>玄武</span>)</p>} decorated />
        <div className='Description'>
          <p>
            <a href='https://yokai.com/genbu/' target='_blank' rel="noreferrer">Genbu (玄武)</a>, the Black Warrior of the North, is depicted as a turtle-snake chimera,
            or a tortoise intertwined with a snake. He is one of the Four Symbols (Seiryu, Suzaku, Genbu, and Byakko), each associated with a cardinal direction. Genbu
            is the protector of the North, controls water and the cold, and represents the virtue of knowledge. At the time, it was believed that all turtles were female
            and had to mate with snakes to reproduce; the intertwining of the two symbols became a symbol of long life and fertility, and of the balance of yin and yang.
          </p>
          <img src={genbu} alt='Genbu' />
        </div>
      </div>
      <div className='Guardian'>
